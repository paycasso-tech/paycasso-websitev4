...
//             full_amount: "$10",
//             payment_for:
//               "Full compensation for the services provided under this Agreement.",
...
//           {
//             task_description:
//               "Create one high-quality, professionally photographed image.",
//             description:
//               "The image must feature SparkleFizz Co.'s flagship beverage, SparkleFizz Original Citrus, capturing its vibrant qualities as a premium summer beverage.",
//             details: [
...
//             additional_details:
//               "A hand holding or pouring the drink is optional but encouraged.",
//           },
//           {
//             task_description: "Deliver final image files.",
//             description:
//               "The Content Creator is required to provide one primary image and two social media adaptations in specific file formats.",
//             details: [
...
//             responsible_party: "Alex Thompson (Content Creator)",
//             additional_details:
//               "The resolution must be suitable for digital and print usage.",
//           },
//           {
//             task_description: "Pay the Content Creator for their services.",
//             description:
//               "The Brand shall pay the Content Creator $10 as full compensation for the services provided under the agreement.",
//             details: [],
//             due_date:
//               "Within 30 days of submission and approval of the final image.",
//             responsible_party: "SparkleFizz Co. (Brand)",
//             additional_details:
//               "Payment is contingent on the Brand's approval of the deliverables.",
//           },
//           {
//             task_description: "Manage the content revision process.",
//             description:
//               "The Brand must notify the Content Creator if revisions are needed, and one revision is included in the scope of work.",
//             details: [
...
//             responsible_party:
//               "SparkleFizz Co. (Brand) for notification, Alex Thompson (Content Creator) for revision",
//             additional_details: "",
//           },
//           // {
